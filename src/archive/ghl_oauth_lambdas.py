...
def initiate_auth():
    ...
    options = {
        "requestType": "code",
        "redirectUri": "https://28hlvh5575.execute-api.us-west-2.amazonaws.com/default/oauth/callback",
...
def refresh():
    ...
    data = {
        ...
        'user_type': 'Location',
        'redirect_uri': 'https://28hlvh5575.execute-api.us-west-2.amazonaws.com/default/oauth/callback'
    }
